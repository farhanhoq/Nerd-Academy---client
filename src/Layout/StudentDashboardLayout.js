              ...
              <ul className="space-y-2 tracking-wide text-white ">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="group-hover:text-gray-700 focus:text-white">Announcements</span>
                    {/* <Link to="/dashboard/announcement"><span className="group-hover:text-gray-700">Announcement</span></Link> */}
                  </Link>
                </li>
                <li>
                  <Link
