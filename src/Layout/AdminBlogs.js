                ...
                <div className="card-body">
                    ...
                    <div className="flex w-full">
                        <div className="grid h-20 flex-grow card bg-base-300 rounded-box place-items-center">
                            <p>Author Image</p>
                            <input  {...register("writerImage")} type="file" className="file-input file-input-ghost w-full max-w-xs" />
                        </div>
                        <div className="divider divider-horizontal">AND</div>
                        <div className="grid h-20 flex-grow card bg-base-300 rounded-box place-items-center">
                            <p>Blog Image</p>
                            <input  {...register("blogImage")} type="file" className="file-input file-input-ghost w-full max-w-xs" />
                        </div>
                    </div>
                    <div className='mt-3'>
                        <JoditEditor
