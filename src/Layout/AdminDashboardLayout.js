                    ...
                    <ul className="mt-32 menu p-4 w-80 lg:bg-opacity-0 text-white">
                        <div>
                            <ul class="space-y-2 tracking-wide text-white ">
                                ...
                                <li>
                                    <Link to="/admin-dashboard/item" className='text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group'>
                                ...
                                <li>
                                    <Link to="/admin-dashboard/users" className='text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group'>
                                        <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
                                        </svg>
                                        <span class="ml-3 flex-1 whitespace-nowrap">Users</span></Link>
                                </li>
                                <li>
