                            ...
                            <ul class="space-y-2 tracking-wide text-white ">
                                ...
                                <li>
                                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                        ...
                                        <Link to="/dashboard/settings"><span class="group-hover:text-gray-700">Setting</span></Link>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                        <svg className='text-white' xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
