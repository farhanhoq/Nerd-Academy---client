            ...
            <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
                    <div class="-mx-6 px-6 py-4">
                        <a href="#" title="home">
                            <img className='w-32' src="https://tailus.io/sources/blocks/stats-cards/preview/images/logo.svg" alt="" srcset="" />

                        </a>
                    </div>

                    <div class="mt-8 text-center">
                        <img className='w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28' src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" alt="" srcset="" />
