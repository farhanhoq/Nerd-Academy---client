    ...
    >
...

      {
        user?.uid ?
          ...
          :
          <>
            <Link to="/login" className="btn btn-primary item hover:btn-outline">Login</Link>
            <Link to="/register" className="btn btn-primary item hover:btn-primary hover:text-white">Register</Link>
          </>
      }
