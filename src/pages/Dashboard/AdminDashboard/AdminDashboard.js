...
const AdminDashboard = () => {
    ...
    return (
        <div className='mx-auto'>
            <h2 className='my-12 text-4xl font-bold text-primary text-center'>Welcome to Admin Dashboard</h2>
            ...
            <div>
                    ...
                    <div className="px-3 py-3 lg:px-5 lg:pl-3">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
                                <h5 hidden className="text-xl text-gray-600 font-medium lg:block">Admin Dashboard</h5>
                            ...
                            <div className="flex items-center justify-start">
                                ...
                                <form action="#" method="GET" className="hidden lg:block lg:pl-32">
                                    ...
                                    <div className="mt-1 relative lg:w-64 ml-96">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
                                            </svg>
                                        </div>
                                        <input className='shadow-xl rounded-lg' type="text" name='email' id='topbar-search' />
                                    </div>
                                </form>
                            </div>
                ...
                <div className="card my-12 bg-base-100 shadow-xl pt-12">

                    <div className="bg-gray-900 opacity-50 hidden" id="sidebarBackdrop"></div>
                    <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto">
                                    ...
                                    <div className="bg-white shadow rounded-lg p-4 sm:p-4 xl:p-8 ">
                                        <div className="flex items-center">
                                            <div className="flex-shrink-0">
                                                ...
                                                <h3 className="text-base font-normal text-gray-500">New Courses this week</h3>
                                            </div>
                                            ...
                                            <ul className='divide-y divide-gray-200'>
                                                <li className="py-3 sm:py-4">
                                                    <div className="flex items-center space-x-4">
                                                        <div className="flex-shrink-0">
                                                            <img className='h-8 w-8 rounded-full' src="https://demo.themesberg.com/windster/images/users/lana-byrd.png" alt="" srcset="" />
                                                        </div>
                        ...
                        <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
                            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
                                <li><Link to="" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Terms and conditions</Link></li>
                                <li><Link to="" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Privacy Policy</Link></li>
                                <li><Link to="" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Licensing</Link></li>
                                <li><Link to="" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Cookie Policy</Link></li>
                                <li><Link to="" className="text-sm font-normal text-gray-500 hover:underline">Contact</Link></li>
                            </ul>
