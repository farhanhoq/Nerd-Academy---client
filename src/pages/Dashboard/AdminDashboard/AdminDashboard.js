...
const AdminDashboard = () => {
    ...
    return (
        <div className='mx-auto'>
            <h2 className='mt-12 mb-6 text-4xl font-bold text-primary text-center'>Welcome to Admin Dashboard</h2>
                                ...
                                <div className="bg-white shadow rounded-lg p-4 sm:p-4 xl:p-8 ">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            <span className="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{courses?.length}</span>
                                            <h3 className="text-base font-normal text-gray-500">Total Courses</h3>
                                        </div>
                                ...
                                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            ...
                                            <h3 className="text-base font-normal text-gray-500">User SignUps</h3>
                                        </div>
                                ...
                                <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                                    ...
                                    <div className="flow-root">
                                        <ul className='divide-y divide-gray-200'>
                                            ...
                                            {
                                                perchasedCourse.map(customer => <li key={customer?._id} className="py-3 sm:py-4">
                                                    <div className="flex items-center space-x-4">
                                                        <div className="flex-shrink-0">
                                                            <img className='h-8 w-8 rounded-full' src={customer?.picture} alt="customer" />
                                                        </div>
