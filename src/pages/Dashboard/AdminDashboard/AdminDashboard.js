                    ...
                    <div class="px-3 py-3 lg:px-5 lg:pl-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                                <h5 hidden class="text-xl text-gray-600 font-medium lg:block">Admin Dashboard</h5>
                            ...
                            <div class="flex items-center justify-start">
                                ...
                                <form action="#" method="GET" class="hidden lg:block lg:pl-32">
                                    ...
                                    <div class="mt-1 relative lg:w-64 ml-96">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
                                            </svg>
                                        </div>
                                        <input className='shadow-xl rounded-2xl' type="text" name='email' id='topbar-search' />
                                    </div>
                                </form>
                            </div>
                    ...
                    <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto">
                        <main>
                            <div class="pt-6 px-4">
                                ...
                                <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                    <div class="bg-white shadow rounded-lg p-4 sm:p-4 xl:p-8 ">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">2,340</span>
                                                <h3 class="text-base font-normal text-gray-500">New Courses this week</h3>
                                            </div>
                        ...
                        <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
                            <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                                <li><Link href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Terms and conditions</Link></li>
                                <li><Link href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Privacy Policy</Link></li>
                                <li><Link href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Licensing</Link></li>
                                <li><Link href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Cookie Policy</Link></li>
                                <li><Link href="#" class="text-sm font-normal text-gray-500 hover:underline">Contact</Link></li>
                            </ul>
