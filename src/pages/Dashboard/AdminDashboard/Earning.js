...
const Earning = () => {
    return (
        <div>
            ...
            {/* start earning page */}
            <div id="content" class="bg-base-100 shadow-xl col-span-9 rounded-lg p-6">
                <div id="24h">
                    <h1 class="font-bold py-4 uppercase">Last 24h Statistics</h1>
                    <div id="stats" class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                        <div class="bg-gradient-to-r from-sky-600 to-cyan-400 p-6 rounded-lg">
                            ...
                            <tr class="border-b border-gray-700">
                                <td class="py-3 px-2 font-bold">
                                    <div class="inline-flex space-x-3 items-center">
                                        <span> <img className='rounded-full h-8 w-8' src="https://images.generated.photos/tGiLEDiAbS6NdHAXAjCfpKoW05x2nq70NGmxjxzT5aU/rs:fit:256:256/czM6Ly9pY29uczgu/Z3Bob3Rvcy1wcm9k/LnBob3Rvcy92M18w/OTM4ODM1LmpwZw.jpg" alt="" srcset="" /> </span>
                                        <span>Thai Mei</span>
                                    </div>
                                </td>
