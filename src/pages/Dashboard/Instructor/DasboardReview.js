            ...
            <section class="my-14 2xl:py-44 bg-blueGray-100 rounded-t-10xl overflow-hidden">
                <div class="container px-4 mx-auto">
                    ...
                    <div class="mb-2 shadow-lg rounded-t-8xl rounded-b-5xl overflow-hidden">
                        <div class="pt-3 pb-3 md:pb-1 px-4 md:px-16 bg-white bg-opacity-40">
                            <div class="flex flex-wrap items-center">
                                <img className='h-12 w-12 mr-4' src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="" srcset="" />
                                ...
                                <div class="w-full md:w-2/3 mb-6 md:mb-0">
                                    ...
                                    <div class="-mb-2">
                                        <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                                <div class="flex mr-2 w-8 h-8 items-center justify-center bg-white rounded-full text-cyan-500">
                                                ...
                                                <span class="text-cyan-500 font-heading font-medium">technology</span>
                                            </div>
                                        </div>
                                        <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                                ...
                                                <span class="text-cyan-500 font-heading font-medium">functionality</span>
                                            </div>
                                        </div>
                                        <div class="inline-flex w-full md:w-auto mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                                ...
                                                <span class="text-cyan-500 font-heading font-medium">Redux</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="-mb-2">
                                        <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                                ...
                                                <span class="text-cyan-500 font-heading font-medium">react</span>
                                            </div>
                                        </div>
                                        <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                        ...
                                        <div class="inline-flex w-full md:w-auto mb-2">
                                            <div class="flex items-center h-12 pl-2 pr-6 bg-cyan-100 border-2 border-cyan-500 rounded-full">
                                                ...
                                                <span class="text-cyan-500 font-heading font-medium">term</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="text-center">
                        <button class="w-40 md:w-auto h-full py-2 px-6 font-medium tracking-tighter text-lg text-white bg-gradient-to-r from-sky-600 to-cyan-400 focus:ring-cyan-500 focus:ring-opacity-50 rounded-xl">See all</button>
                    </div>
                </div>
            </section>
        </div>
