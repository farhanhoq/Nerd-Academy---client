        ...
        <td>
          <div className="flex items-center space-x-3">
            ...
            <div className=''>
              ...
              <div className="text-sm ">By <span className='badge badge-ghost'>{data?.creator}</span></div>
              <div className="text-sm ">Video: <span className='opacity-70'>{data?.hours} hours</span></div>
              <div className="text-sm ">Lectures: <span className='opacity-70'>{data?.lectures}</span></div>
            </div>
          </div>
        </td>
        <td>
          <div className='text-right'>
            ...
            <a className='text-red-500 hover:underline cursor-pointer'>Remove</a><br />
            <a className='hover:underline cursor-pointer'>Save for later</a>
    ...
    <div className='w-5/12'>
        <div className='border border-primary rounded-xl p-4 w-7/12 mx-auto'>
             <h4 className='text-xl font-bold mb-2'>Total</h4>
                        ...
                        <button className='btn btn-primary rounded text-white btn-wide w-full mt-5'>Checkout</button>
        </div>
