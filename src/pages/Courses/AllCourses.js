    ...
    return (
        <div className='py-24'>
            ...
            <div className='my-12 mx-24'>
                <h2 className='text-3xl font-medium mb-2 text-secondary'>Web Development</h2>
                <hr />
            ...
            <div className='my-12 mx-24'>
                <h2 className='text-3xl font-medium text-secondary mb-2'>Programming</h2>
                <hr />
            ...
            <div className='my-12 mx-24'>
                <h2 className='text-3xl font-medium text-secondary mb-2'>Computer Science</h2>
                <hr />
            ...
            <div className='my-12 mx-24'>
                <h2 className='text-3xl font-medium text-secondary mb-2'>Artificial Intelligence</h2>
                <hr />
            ...
            <div className='my-12 mx-24'>
                <h2 className='text-3xl font-medium text-secondary mb-2'>App Development</h2>
                <hr />
