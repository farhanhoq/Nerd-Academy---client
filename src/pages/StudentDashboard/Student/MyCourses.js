          ...
          <div className="card lg:card-side bg-base-100 shadow-xl p-2 bg-slate-200">
            ...
            <div className="text-left text-black p-3">
              ...
              <div className="card-actions mt-5 justify-end">
                <Link
                  to="/module"
                  className="btn btn-primary rounded text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                  Continue course
                </Link>
                <div className="text-right mt-1">
                  <label
                    htmlFor="teacher-modal"
                    className=" rounded border-none btn-xs text-xs capitalize btn bg-gradient-to-r from-sky-600 to-cyan-400"
                  >
                    Add teacher review
                  </label>
                  <label
                    htmlFor="my-modal"
                    className="block pt-1 mt-1 rounded border-none btn-xs text-xs capitalize btn bg-gradient-to-r from-sky-600 to-cyan-400"
                  >
                    Add course review
                  </label>
                </div>
