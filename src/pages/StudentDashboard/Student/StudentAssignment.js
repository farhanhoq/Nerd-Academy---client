                        ...
                        <tbody class="text-sm font-normal text-gray-700 text-left divide-y">
                            {
                                ...
                                <td class="px-4 py-4 items-center">
                                    <button
                                        class="px-2 py-2 bg-red-100 dark:bg-gray-300 rounded text-gray-500 dark:text-gray-600 text-xs font-medium ">{data?.mark}</button>
                                </td>
                                <td class="items-center px-4 py-4">
                                    <div class="font-medium text-sm dark:text-gray-50 dark:group-hover:text-gray-600">{data?.status}</div>
                                </td>
                                <td class="px-4 py-4">
                                    <div
