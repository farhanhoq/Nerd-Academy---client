...
const About = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 mx-8 mt-40">
            ...
            <div className='flex flex-col'>
                ...
                <div className='card md:card-side shadow-md mt-2 text-black w-full h-28' >
                    ...
                    <div className="w-full mt-4 ml-6">
                        ...
                        <p>Block Slacks Contribution To Building A Better Collae You can learn almost anything for free, but it's also easy to spend hours</p>
